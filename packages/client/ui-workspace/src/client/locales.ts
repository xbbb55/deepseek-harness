...
export const zh = {
  ...
  'delete.session.confirm': '永久删除此会话及其磁盘日志？此操作不可撤销。',
...
export const en = {
  ...
  'delete.session': 'Permanently delete session',
  'delete.session.confirm': 'Permanently delete this session and its disk log? This cannot be undone.',
